...
Voilà pour aujourd'hui, nous arrêterons là.  La suite se concentrera sur le "module Secure":http://github.com/mcgivrer/myplayapp/blob/master/playframework-partie-2.3.textile et son implémentation, ainsi que sur la customisation de la page d'accueil de l'application. Nous en profiterons également pour mettre en place une belle zone d'administration avec plein d'information.
