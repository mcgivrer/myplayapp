...
public class UserAvatar {
	 ...
	 * @param type
	 */
	private UserAvatar(String UUID, String type) {
		this.UUID = UUID;
		this.type = type;
	}
	...
	public void generateThumbnails() throws Exception {
		...
		for (int i = 0; i < setThumbnailsSize().length; i++) {
			...
			models.shared.Thumbnail.create(getFile(sizeName), getFile(""), size);
		}
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object o)
		...
		return new UserAvatar(val.split("[|]")[0], val.split("[|]")[1]);
	}

	public void nullSafeSet(PreparedStatement ps, Object o, int i)
			throws HibernateException, SQLException {
		if (o != null) {
			ps.setString(i, ((UserAvatar) o).UUID + "|" + ((UserAvatar) o).type);
		} else {
	...
	public Object deepCopy(Object o) throws HibernateException {
		...
		return new UserAvatar(this.UUID, this.type);
	}
